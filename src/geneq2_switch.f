...
c                  a(jmia+nmat(3))=a(jmia+nmat(3))+dvapi
c                  a(jmia+nmat(4))=a(jmia+nmat(4))+dvaei
c                  a(ial+nmat(3))=a(ial+nmat(3))-dvapi
c                  a(ial+nmat(4))=a(ial+nmat(4))-dvaei
c                  a(iau+nmat(3))=a(iau+nmat(3))+dvapkb
c                  a(iau+nmat(4))=a(iau+nmat(4))+dvaekb
c                  a(jml+nmat(3))=a(jml+nmat(3))-dvapkb
c                  a(jml+nmat(4))=a(jml+nmat(4))-dvaekb
 65            continue
            endif
c         endif
c     
