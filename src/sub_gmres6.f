      subroutine sub_gmres6(neq,a,b,r,na,nb,nrhs
...
CD2
CD2 $Log:   /pvcs.config/fehm90/src/sub_gmres6.f_a  $
!D2 
!D2    Rev 2.5   06 Jan 2004 10:44:10   pvcs
!D2 FEHM Version 2.21, STN 10086-2.21-00, Qualified October 2003
!D2 
!D2    Rev 2.4   29 Jan 2003 09:19:44   pvcs
!D2 FEHM Version 2.20, STN 10086-2.20-00
!D2 
!D2    Rev 2.3   14 Nov 2001 13:15:32   pvcs
!D2 FEHM Version 2.12, STN 10086-2.12-00
!D2 
!D2    Rev 2.2   06 Jun 2001 13:27:42   pvcs
!D2 FEHM Version 2.11, STN 10086-2.11-00
!D2 
!D2    Rev 2.1   30 Nov 2000 12:11:50   pvcs
!D2 FEHM Version 2.10, STN 10086-2.10-00
!D2 
!D2    Rev 2.0   Fri May 07 14:46:48 1999   pvcs
...
CD4 sub_bksub6      N/A       Performs back-substitution, 6 dof
...
c     note dimension of h is 1
      ...
      integer neq
      real*8 xx(neq,6),a(*),b(*),r(*),sorthm(*),rw(*)
...
c     
      call sub_bksub6(neq,b,r,nb,nrhs,nop
     *     ,npvt,piv)
c     
c     
*------------------------------------------------------
...
c     compute m(-1)*av
      call sub_bksub6(neq,b,rw,nb,nrhs_dum,nop
     *     ,npvt,piv)
c
*     ----------------------------------
 ...
 1910 continue
      ...
      if (abs(g(jnorth+1)).le.epn) then
         ...
         if(iter.gt.maxit) then
            if( iptty .ne. 0 ) then
               write(iptty,34)
 34            format(/,1x,'Warning issued by 6 degree of freedom '
     &              ,'solver:')
