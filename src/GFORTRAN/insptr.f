...
c gfortran does not support 'binary'
c         open(isptr2, file = nmfil(18), status = cstats(18),
c     2        form='binary')
c         write(isptr2)  verno, jdate, jtime
c         write(isptr2)  ptitle         
c         if (iprto .lt. 0) write(isptr2) num_part
         write(ierr, 120) 
