...
c gaz 091025
      ...
      real*8, allocatable ::  t20a(:)
      real*8, allocatable ::  t21a(:)
      real*8, allocatable ::  t5_nd(:) 
      real*8, allocatable ::  t8_nd(:) 
      real*8, allocatable ::  t9_nd(:) 
c gaz 191025
      real*8, allocatable ::  t11c(:)
      real*8, allocatable ::  t12c(:)
      real*8, allocatable ::  t13c(:)
      real*8, allocatable ::  t14c(:) 
      real*8, allocatable ::  t15c(:) 
      real*8, allocatable ::  t16c(:) 
      real*8, allocatable ::  t21c(:)
      real*8, allocatable ::  t22c(:)
      real*8, allocatable ::  t23c(:)
      real*8, allocatable ::  t24c(:) 
      real*8, allocatable ::  t25c(:) 
      real*8, allocatable ::  t26c(:)
      real*8, allocatable ::  t31c(:)
      real*8, allocatable ::  t32c(:)
      real*8, allocatable ::  t33c(:)
      real*8, allocatable ::  t34c(:) 
      real*8, allocatable ::  t35c(:) 
      real*8, allocatable ::  t36c(:)  
