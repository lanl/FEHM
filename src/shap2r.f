...
CD1  PURPOSE
CD1
CD1  Evaluate 2-D finite element shape functions at quadrature points. 
CD1  Calculates 4-node quad.
CD1
C***********************************************************************
CD2
CD2  REVISION HISTORY 
CD2
CD2 $Log:   /pvcs.config/fehm90/src/shap2r.f_a  $
!D2 
...
!D2 
!D2    Rev 2.0   Fri May 07 14:45:34 1999   pvcs
!D2 FEHM Version 2.0, SC-194 (Fortran 90)
CD2 
CD2    Rev 1.3   Thu Jan 18 10:50:10 1996   zvd
CD2 Modifications to prolog
CD2 
CD2    Rev 1.2   Thu Jan 11 11:04:02 1996   hend
CD2 Added Prolog
CD2 
CD2    Rev 1.1   03/18/94 15:58:00   gaz
CD2 Added solve_new and cleaned up memory management.
CD2 
CD2    Rev 1.0   01/20/94 10:27:42   pvcs
...
CD7   tintg           REAL*8   Integration constant
CD7
...
c define integration points
      ...
      do 20 i=1,nsl
      wr(nga,i)=0.25*(1.+xd(i)*si(nga))*(1.+yd(i)*eta(nga))
      wxr(nga,i)=0.25*xd(i)*(1.+yd(i)*eta(nga))
      wyr(nga,i)=0.25*yd(i)*(1.+xd(i)*si(nga))
      dr(nga)=1.
   20 continue
