      subroutine dispersion_divergence_omr(i)
!***********************************************************************
...
!D1 PURPOSE
!D1
!D1 On OMR grid, using a least squares to interpolate,
!D1 calculate the dispersion tensor and its divergence
!D1
!**********************************************************************
!D2
!D2 REVISION HISTORY
...
c D and div.D terms for the general dispersion tensor
      ...
      if(current_flag.eq.2.or.current_flag.eq.4) then
         ...
         call velocity_derivatives_lsq(i,dvd,dvxd,dvyd,dvzd,v,vv)
...
c     general tensor
            ...
            if(term1.gt.1.0) then
               write(*,*)' error in divd_general. sum of direction '
               write(*,*)'cosines must be le 1. Check sptr input.'
               write(ierr,*) 'STOP'
               stop
            endif
...
c     NOTE v is the normalized velicity, ie v(1)=Vx/vv etc.
            ...
            divd_omr(i,j)=(term1+term2+term3+term4+term5+term6)/pormax
...
c.............................................
      ...
      end subroutine dispersion_divergence_omr
