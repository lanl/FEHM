      subroutine sfn3r (sid,etad,excid)
!***********************************************************************
...
CD1 PURPOSE
CD1
CD1 Evaluate shape functions for 3D calculations. 
CD1
C***********************************************************************
CD2
...
CD2
CD2 $Log:   /pvcs.config/fehm90/src/sfn3r.f_a  $
!D2 
!D2    Rev 2.5   06 Jan 2004 10:43:54   pvcs
!D2 FEHM Version 2.21, STN 10086-2.21-00, Qualified October 2003
!D2 
!D2    Rev 2.4   29 Jan 2003 09:15:22   pvcs
!D2 FEHM Version 2.20, STN 10086-2.20-00
!D2 
!D2    Rev 2.3   14 Nov 2001 13:12:40   pvcs
!D2 FEHM Version 2.12, STN 10086-2.12-00
!D2 
!D2    Rev 2.2   06 Jun 2001 13:26:42   pvcs
!D2 FEHM Version 2.11, STN 10086-2.11-00
!D2 
!D2    Rev 2.1   30 Nov 2000 12:07:42   pvcs
!D2 FEHM Version 2.10, STN 10086-2.10-00
!D2 
!D2    Rev 2.0   Fri May 07 14:45:32 1999   pvcs
!D2 FEHM Version 2.0, SC-194 (Fortran 90)
CD2 
CD2    Rev 1.2   Fri Feb 02 10:38:32 1996   hend
CD2 Updated Requirements Traceability
CD2 
CD2    Rev 1.1   03/18/94 15:55:48   gaz
...
CD3                                   the numerical integration points
CD3   excid           REAL*8   I    Local coordinates in a finite element of
CD3                                   the numerical integration points
CD3
...
CD4                                     finite element
CD4   zd              REAL*8   fbs    Global coordinates of the nodes in a
CD4                                     finite element
CD4
...
CPS BEGIN sfn3r
CPS 
CPS   set number of coordinate postions to 8
...
c**** local coordinates ****
      ...
      do i = 1, nsl
         w (i,1) = 0.125 * (1.0 + xd(i) * sid) * (1.0 + yd(i) * etad)
     .        * (1.0 + zd(i) * excid)
         wx(i,1) = 0.125 * xd(i) * (1.0 + yd(i) * etad) 
     .        * (1.0 + zd(i) * excid)
         wy(i,1) = 0.125 * yd(i) * (1.0 + xd(i) * sid) 
     .        * (1.0 + zd(i) * excid)
         wz(i,1) = 0.125 * zd(i) * (1.0 + xd(i) * sid) 
     .        * (1.0 + yd(i) * etad)
      end do
