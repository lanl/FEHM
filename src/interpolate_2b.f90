...
!***********************************************************************
  ...
  public   read_interpolation_data_2,              &
       write_interpolation_data_2,                 &
       get_air_error_message,                    &
       get_air_property_type,                    &
       get_air_state,                        &
       get_air_sat_pressure,                 &
       get_air_sat_temperature,              &
       get_air_properties,                   &
       get_air_sat_properties_pressure,      &
       get_air_sat_props_temperature,        &
       get_air_sat_line_props_pressure,      &
       get_air_sat_line_props_temperat,      &
...
contains
  ...
  subroutine get_air_error_message(astring)
    ...
    return
  end subroutine get_air_error_message




  subroutine read_interpolation_data_2(ifail,infile,v_1,v_2,v_3,v_4)
...
9890 ifail=1
  ...
  end subroutine read_interpolation_data_2



  subroutine get_air_property_type(ifail,ind,astring)

    ! -- Subroutine GET_air_PROPERTY_TYPE retrieves the property type pertaining to an array index.
    ...
    if((ind.lt.1).or.(ind.gt.na))then
       write(amessage,10)
10     format('Error in subroutine GET_air_PROPERTY_TYPE: supplied index out of range.')
       ifail=1
       return
    end if
    ...
    return
  end subroutine get_air_property_type



  subroutine get_air_state(ifail,temperature,pressure,state)

    ! -- Subroutine GET_air_STATE returns the state of h2o at the requested
...
200 ic_last=ic
  ...
  subroutine get_air_sat_pressure(ifail,temperature,pressure,dp_dt)

    ! -- Subroutine GET_air_SAT_PRESSURE gets the saturation pressure corresponding to a certain
    !    temperature.
  ...
  end subroutine get_air_sat_pressure
...
10     format('Error in subroutine GET_SAT_PRESSURE_1: supplied temperature is out of ',  &
  ...
  subroutine get_air_sat_temperature(ifail,pressure,temperature,dt_dp)
  ...
  end subroutine get_air_sat_temperature
...
10     format('Error in subroutine GET_SAT_TEMPERATURE_1: supplied pressure is out of ',  &
  ...
  subroutine get_air_properties(ifail,iphase,ncode,icode,temperature,pressure,value)

    ! -- Subroutine GET_air_PROPERTIES obtains h2o properties through interpolation from a table.
...
9890 ifail=1
  ...
  end subroutine get_air_properties



  subroutine get_air_sat_properties_pressure(ifail,iphase,ncode,icode,pressure,value)

    ! -- Subroutine GET_air_SAT_PROPERTIES_PRESSURE gets saturation properties pertaining to a certain
    !    pressure.
...
20        format('Error in subroutine GET_air_SAT_PROPERTIES_PRESSURE: phase code must be "1" or "2".')
  ...
  end subroutine get_air_sat_properties_pressure


  !get_air_sat_properties_temperature
  subroutine get_air_sat_props_temperature(ifail,iphase,ncode,icode,temperature,value)

    ! -- Subroutine GET_air_SAT_PROPERTIES_TEMPERATURE gets saturation properties pertaining to a certain
    !    temperature.
...
20        format('Error in subroutine GET_air_SAT_PROPERTIES_TEMPERATURE: phase code must be "1" or "2".')
  ...
  end subroutine GET_air_SAT_PROPS_TEMPERATURE
  ! get_air_sat_properties_temperature



  subroutine get_air_sat_line_props_pressure(ifail,iphase,ncode,icode,pressure,value)
    ...
    if(pp.gt.psat_max)then
       ...
       write(amessage,10)
10     format('Error in subroutine GET_air_SAT_LINE_PROPS_PRESSURE: ',   &
       ...
       if(iphase.eq.1)then
          ...
          write(amessage,20)
20        format('Error in subroutine GET_air_SAT_LINE_PROPS_PRESSURE: ',  &
  ...
  end subroutine get_air_sat_line_props_pressure


  ! get_air_sat_line_props_temperature
  subroutine get_air_sat_line_props_temperat(ifail,iphase,ncode,icode,temperature,value)
    ...
    if(tt.gt.tsat_max)then
       ...
       write(amessage,10)
10     format('Error in subroutine GET_air_SAT_LINE_PROPS_TEMPERATURE: ',  &
       ...
       if(iphase.eq.1)then
          ...
          write(amessage,20)
20        format('Error in subroutine GET_air_SAT_LINE PROPS_TEMPERATURE: ',  &
               'phase code must be "1" or "2".')
          ifail=1
          return
       end if
  ...
  end subroutine get_air_sat_line_props_temperat
  ! get_air_sat_line_props_temperature
...
10     CONTINUE
 ...
 subroutine write_interpolation_data_2(ifail,infile,outfile,auxfile)

    ! --  Subroutine write_interpolation_data_2 reads an interpolation dataset.
    ! --  Subroutine write_interpolation_data_2 writes a modified interpolation dataset.
...
9890 ifail=1
  ...
  end subroutine write_interpolation_data_2


end module property_interpolate_2 
