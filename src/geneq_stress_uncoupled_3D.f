      subroutine geneq_stress_uncoupled_3D(i)
!***********************************************************************
...
c x equation derivatives
      ...
      a(jmia+nmat(3))=a(jmia+nmat(3))-xz     
     
      a(iau+nmat(1))=a(iau+nmat(1))+xx   
      a(iau+nmat(2))=a(iau+nmat(2))+xy
      a(iau+nmat(3))=a(iau+nmat(3))+xz       
                
      
c y equation derivatives

      a(jmia+nmat(4))=a(jmia+nmat(4))-yx
      a(jmia+nmat(5))=a(jmia+nmat(5))-yy
      a(jmia+nmat(6))=a(jmia+nmat(6))-yz     
     
      a(iau+nmat(4))=a(iau+nmat(4))+yx
      a(iau+nmat(5))=a(iau+nmat(5))+yy
      a(iau+nmat(6))=a(iau+nmat(6))+yz    
                  
c z equation derivatives   

      a(jmia+nmat(7))=a(jmia+nmat(7))-zx
      a(jmia+nmat(8))=a(jmia+nmat(8))-zy
      a(jmia+nmat(9))=a(jmia+nmat(9))-zz       
...
c
c           tdumt=t(kb)-tini(kb)
c           pdumt=phi(kb)-phini(kb)
c           tdumt=t(kb)-tini(kb)
c           pdumt=phi(kb)-phini(kb)
...
c
      ...
      subroutine stress_boun3(iflg,iz)
c
...
c check for z fixed displacement	 
c           i1 = nelm(i)+1
c           i2 = nelm(i+1)
           do jj= i1,i2
            kb = nelm(jj)
...
c    added force
	     forcz_boun = forc(i,3)
	     bp(i+nrhs(3)) = bp(i+nrhs(3)) - forcz_boun
		endif  		  
       enddo
      else if(iflg.eq.2) then
c
c  check for fixed displacements (T and P derivatives)
c
c  check stress_combine for nmat positions
	 neqp1 = neq+1
	 do i = 1,neq
c check for x fixed displacement	     
           i1 = nelm(i)+1
	      ...
	      if(krdu.eq.1) then
            do jj= i1,i2
             jjkb = jj-neqp1
             a(jjkb+nmat(10)) = 0.0d0 
             a(jjkb+nmat(11)) = 0.0d0                      
            enddo
		endif     
c check for y fixed displacement	 
          krdv = kr(i,2)
	    if(krdv.eq.2) then
            do jj= i1,i2
             jjkb = jj-neqp1
             a(jjkb+nmat(12)) = 0.0d0 
             a(jjkb+nmat(13)) = 0.0d0  
            enddo
		endif
c check for z fixed displacement	 
          krdw = kr(i,3)
	    if(krdw.eq.3) then
            do jj= i1,i2
             jjkb = jj-neqp1
             a(jjkb+nmat(14)) = 0.0d0 
             a(jjkb+nmat(15)) = 0.0d0             
            enddo
 		endif  		  
       enddo
