...
!D2 
!D2 $Log:   /pvcs.config/fehm90/src/gensmethh2o_equil.f_a  $
!D2
!D2 
!***********************************************************************
!D3
...
c
        call icectr(10,0)
c     identify mobile methane and water (and immobles farctions)
...
c     call ther_meth_h2o to get hydrate terms
         call ther_meth_h2o(3,0)
c     remove kinetic rate terms
         call  hydrate_equil(4,3)
c 
c note  geneq_hyd_equil adds contribution to methane and water balances 
c  
      do id = 1,neq
          call geneq_hyd_equil(id)
      enddo
c  
c
...
c     remove kinetic rate terms
         call  hydrate_equil(4,2)
      do id = 1,neq
          call geneq_meth(id)
      enddo
c 
c correct for mobile methane and water 
c
	call  hydrate_equil(3,0)
c after this call variables should be total fractions
...
c
c     calculate terms and derivatives for variable change
c
         call  hydrate_equil(1,0)
c
