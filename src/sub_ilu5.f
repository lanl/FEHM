      subroutine  sub_ilu5(nel,a,b,na,nb,ncon,nop
     *     ,irb,iirb,npvt,dum1,dum2,dum3,dum4,dum5,piv)
!***********************************************************************
...
CD1 PURPOSE
CD1
CD1 To perform incomplete lu factorization for 5 degree of freedom
CD1 problem.
CD1
C**********************************************************************
CD2
...
CD2
CD2 $Log:   /pvcs.config/fehm90/src/sub_ilu5.f_a  $
!D2 
!D2    Rev 2.5   06 Jan 2004 10:44:14   pvcs
!D2 FEHM Version 2.21, STN 10086-2.21-00, Qualified October 2003
!D2 
!D2    Rev 2.4   29 Jan 2003 09:19:58   pvcs
!D2 FEHM Version 2.20, STN 10086-2.20-00
!D2 
!D2    Rev 2.3   14 Nov 2001 13:15:46   pvcs
!D2 FEHM Version 2.12, STN 10086-2.12-00
!D2 
!D2    Rev 2.2   06 Jun 2001 13:27:52   pvcs
!D2 FEHM Version 2.11, STN 10086-2.11-00
!D2 
!D2    Rev 2.1   30 Nov 2000 12:12:14   pvcs
!D2 FEHM Version 2.10, STN 10086-2.10-00
!D2 
!D2    Rev 2.0   Fri May 07 14:47:08 1999   pvcs
!D2 FEHM Version 2.0, SC-194 (Fortran 90)
CD2 
CD2    Rev 1.2   Thu Sep 12 08:26:48 1996   robinson
CD2 Prolog Changes
CD2 
CD2    Rev 1.1   Fri Feb 02 14:42:26 1996   hend
...
C**********************************************************************
c
c five degree of freedom solver
c
c     5 degree of freedom ilu preconditioner
      ...
      real*8 a(*),b(*),piv(*)
      real*8 dum1(nel,5),dum2(nel,5),dum3(nel,5),dum4(nel,5)
      real*8 dum5(nel,5)
      integer na(*),nb(*)                    
      integer nelp1
      integer i1, i2, i3, i4
      ...
      integer nb11, nb12, nb13, nb14, nb15
      integer nb21, nb22, nb23, nb24, nb25
      integer nb31, nb32, nb33, nb34, nb35
      integer nb41, nb42, nb43, nb44, nb45
      integer nb51, nb52, nb53, nb54, nb55
      integer i, ifin, ij, ijind, ikb, ka, kb
      integer im1nq2, ipvt, ista, ipvtp1, ipvtm1, j, ik, k, kj, l
      integer j2, kpvt, ikind, kjind
      integer ipvind, ip
      real*8 dd11, dd12, dd13, dd14, dd15
      real*8 dd21, dd22, dd23, dd24, dd25
      real*8 dd31, dd32, dd33, dd34, dd35
      real*8 dd41, dd42, dd43, dd44, dd45
      real*8 dd51, dd52, dd53, dd54, dd55
      real*8 bksb1, bksb2, bksb3, bksb4, bksb5
c       
      nelp1=nel+1
      na11=na( 1)
      na12=na( 2)
