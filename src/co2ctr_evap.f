...
c  
c---------------------------------------------------------------
c          PHS 6/11/07   -999 is for reading Temp from restart
c                        -666 is for air only problem with
c                             no water or water vapor (Truely Dry)
c---------------------------------------------------------------   
            do i=1,n
               pcid=pci(i)
...
c     
c   PHS   4/25/07  Removing humidity stuff
