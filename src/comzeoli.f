...
!D1 the option for hydration of zeolites
!D1
!**********************************************************************
!D2
!D2 REVISION HISTORY
...
!D2
!D2 $Log:   /pvcs.config/fehm90/src/comzeoli.f_a  $
!D2 
...
!D2 
!D2    Rev 2.2   06 Jun 2001 13:22:44   pvcs
!D2 FEHM Version 2.11, STN 10086-2.11-00
!D2 
!D2    Rev 2.1   30 Nov 2000 11:58:38   pvcs
...
!     ***** Variables in COMMON Block zeolites_pointers *****
      real*8, allocatable :: fwater(:)
      real*8, allocatable :: fwater_old(:)
      real*8, allocatable :: kzeol(:)
