...
c
      ...
      integer iz,ndummy,i,irlpd,mi,it,ir,j,num_models,ireg,icesd
      real*8 prop1,dprop11,dprop12,prop2,dprop21,dprop22
...
c				dsl_stardw = 1.d0/(1.d0-rp1)
     ...
     &				(-rp32*sl_star**(rp32-1.d0)))*(dsl_stardg)
				...
				elseif(sc_star.ge.1.d0) then
					...
					prop2=(sc_star**2.d0)*((sl_star**rp32)-(sw_star**rp32))
