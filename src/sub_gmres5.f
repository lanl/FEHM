      subroutine sub_gmres5(neq,a,b,r,na,nb,nrhs
...
CD1 acceleration (five degrees of freedom).
CD1
C**********************************************************************
CD2
...
CD2
CD2 $Log:   /pvcs.config/fehm90/src/sub_gmres5.f_a  $
!D2 
...
!D2 
!D2    Rev 2.3   14 Nov 2001 13:15:30   pvcs
!D2 FEHM Version 2.12, STN 10086-2.12-00
!D2 
!D2    Rev 2.2   06 Jun 2001 13:27:40   pvcs
!D2 FEHM Version 2.11, STN 10086-2.11-00
!D2 
!D2    Rev 2.1   30 Nov 2000 12:11:48   pvcs
!D2 FEHM Version 2.10, STN 10086-2.10-00
!D2 
!D2    Rev 2.0   Fri May 07 14:46:46 1999   pvcs
!D2 FEHM Version 2.0, SC-194 (Fortran 90)
CD2 
CD2    Rev 1.9   Tue Sep 17 09:33:10 1996   robinson
CD2 Changed spelling of orthogalization
CD2 
CD2    Rev 1.8   Mon Sep 16 12:12:10 1996   robinson
CD2 Oh, those nasty prologs
CD2 
CD2    Rev 1.7   Mon Sep 16 11:51:36 1996   robinson
CD2 Prolog change
CD2 
CD2    Rev 1.6   Thu Sep 12 08:26:28 1996   robinson
CD2 Prolog Changes
CD2 
CD2    Rev 1.5   Thu Jul 25 15:57:54 1996   hend
CD2 Fixed to call sub_bksub5 instead of sub_bksub4
CD2 
CD2    Rev 1.4   Fri May 31 15:37:54 1996   gaz
CD2 correction for more general dof reordering
CD2 
CD2    Rev 1.3   Tue May 14 14:32:48 1996   hend
CD2 Updated output
CD2 
CD2    Rev 1.2   Fri Feb 02 14:42:20 1996   hend
CD2 Updated Prolog and Log
CD2
CD2 4-6-94       G. Zyvoloski   97      Initial implementation
CD2 6-24-94      B. Robinson    97      Converted 4 dof version to 5
CD2                                     
CD2
C**********************************************************************
CD3
...
CD4 sub_bksub5      N/A       Performs back-substitution, 5 dof
...
CPS sub_bksub5 - obtain new pre-conditioned solution
CPS 
...
CPS     ENDFOR
CPS     
CPS     sub_bksub5 - compute new pre-conditioned solution
CPS     
...
CPS     ENDFOR
CPS   
CPS     sub_bksb5 - obtain new pre-conditioned solution
CPS   
CPS   ENDIF
CPS 
...
c     note dimension of h is 1
      ...
      integer neq
      real*8 xx(neq,5),a(*),b(*),r(*),sorthm(*),rw(*)
      ...
      real*8 tols, rnorm
      real*8 vhatnm, tmp1, s1, s2, s3, s4, s5, prdinr
      real*8 tmp2, sqroot, sum1, sum2, sum3, sum4, sum5, hh, summ
      integer neqm1, neqp1, maxit, inorth, kk, i
      integer nr1, nr2, nr3, nr5, lu3, k1, k2, jnorm1
      integer k3, nel, k5
      integer na11, na12, na13, na14, na15
      integer na21, na22, na23, na24, na25
      integer na31, na32, na33, na34, na35
      integer na41, na42, na43, na44, na45
      integer na51, na52, na53, na54, na55
...
c     
      call sub_bksub5(neq,b,r,nb,nrhs,nop
     *     ,npvt,piv)
c     
c     
*------------------------------------------------------
*     gmres - five degrees of freedom.
*     
...
c     compute m(-1)*av
      call sub_bksub5(neq,b,rw,nb,nrhs_dum,nop
     *     ,npvt,piv)
c
*     ----------------------------------
 ...
 1910 continue
      ...
      if (abs(g(jnorth+1)).le.epn) then
         ...
         if(iter.gt.maxit) then
            if( iptty .ne. 0 ) then
               write(iptty,34)
 34            format(/,1x,'Warning issued by 5 degree of freedom '
     &              ,'solver:')
