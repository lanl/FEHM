      subroutine flow_flux_perm_residual(Ri,node_I,node_k,duu,dvv,dww
     &     , dpp, flag_u_pp)
!***********************************************************************
...
c      Ri(1) = Ri(1) + sx1(node_I)*deni(node_I) + sk(node_I)
c      Ri(2) = Ri(2) + sx1(node_I)*denei(node_I) + qh(node_I)
      ...
      end subroutine flow_flux_perm_residual
