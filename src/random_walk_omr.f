      subroutine random_walk_omr(iflag,np1, current_node, current_model,
...
!D2 
!D2 Initial implementation: ?, Programmer: Sharad Kelkar
!D2 
!D2 $Log:   /pvcs.config/fehm90/src/random_walk_omr.f_a  $
!D2 
!***********************************************************************
!D3 
