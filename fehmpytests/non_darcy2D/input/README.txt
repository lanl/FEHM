...
Mesh is 2D XY 20x20 with 1 meter spacing
...
The input files differ by ndar value of OFF, 1d9, and 1d10
ndar OFF is Darcy flow, 1d9 and 1d10 have faster velocities

Files presWAT are compared within tolerance
View 00002_sca_node.vtk contours to compare visually
Velocities written to .out with nodes 1,421,21 on the Y-axis P(MPa)
Highest values at node 1 (0,0) and lowest at top node 421 (0,20)
