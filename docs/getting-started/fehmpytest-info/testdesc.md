...
|:---------------------|:-----------------------|:--------------------|
| [**barometric**](/test-details/barometric.md) ```*```| **Barometric Pumping Test**<br>Barometric Pumping Test Pore-scale Velocity<br>Note VV test in barometric checks output from baro_trans and baro_vel  | add baro_trans and baro_vel seperately See [73](https://github.com/lanl/FEHM/issues/73) |
| [**boun**](/test-details/boun.md) ```*```|**Test the Boundry Functionality**<br>Compares the generated contour files to old contour files that are known to be correct. Only the pressure and hydraulic head values at time 2 are tested.| compare scripts fail See [74](https://github.com/lanl/FEHM/issues/74) |
| [**cellbased**](/test-details/cellbased.md) ```*``` |**Test the Cell-Based Particle Tracking Model**<br>Compares the generated output files with the old files known be correct. All values are tested for a root mean square difference of less than 0.05.| compare scripts fail See [71](https://github.com/lanl/FEHM/issues/71) |
| [**dispersion**](/test-details/dispersion.md)| New Analytic Test from Xiang | Needs python driver See [58](https://github.com/lanl/FEHM/issues/58) |
|[**dissolution**](/test-details/dissolution.md) ```*```|**Test the Dissoultion Macro**<br>A one-dimensional transport simulation of calcite (CaC03(s)) dissolution is tested. Profiles of concentration versus reactor length, at selected times, will be compared against the analytical solution.| windows fails test See [75](https://github.com/lanl/FEHM/issues/75) |
| [**doe**](/test-details/doe.md) ```*``` |**Test the DOE Code Comparison Project, Problem 5, Case A**<br>Compares the generated contour and history files to old contour and history files that are known to be correct. For contour files, only the pressure, temperature, and saturation values at time 3 are tested. For history files, all pressure, temperature, and saturation values are tested.| compare scripts fail See [76](https://github.com/lanl/FEHM/issues/76) |
| [**heat_pipe**](/test-details/heat_pipe.md) ```*``` |**Test the Heat Pipe Problem**<br> 1-d heat pipe calculation| win and linux formats differ See [70](https://github.com/lanl/FEHM/issues/70) |
| [**saltvcon**](/test-details/saltvcon.md)|**Test the Salt Variable Conductivity Macro**<br>Tests the calculations of thermal conductivity of crushed and intact salt.| scripts need work for mac and windows See [77](https://github.com/lanl/FEHM/issues/77) |
| [**transport3d**](/test-details/transport3d.md) ```*```|  **Test transport3d**<br> Comparison of Ratio of Permeabilty Change to Ratio of Change in Flow Rate| output files from win and linux differ See [69](https://github.com/lanl/FEHM/issues/69) |
| [**uz_test**](/test-details/uz_test.md) ```*```| france uz setup |  linux and win files differ See [78](https://github.com/lanl/FEHM/issues/78) |
